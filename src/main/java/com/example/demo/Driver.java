...
public class Driver {
    ...
    public String login(String email, String username, String password)
        throws JSONException, HttpClientErrorException {
    ...
    public String access(String token) throws JSONException, HttpClientErrorException {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("token", token);
        return send("/oauth2/access", null, HttpMethod.POST, jsonObject.toString());
    }

    public String logout(String token) throws JSONException, HttpClientErrorException {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("token", token);
        return send("/oauth2/logout", null, HttpMethod.DELETE, jsonObject.toString());
    }

    public String tokenInfo(String token) throws HttpClientErrorException {
        return send("/oauth2/tokenInfo?token=" + token, null, HttpMethod.GET, null);
    }

    public String userInfo(String token) throws HttpClientErrorException {
        return send("/oauth2/userInfo", token, HttpMethod.GET, null);
    }

    public String listUsers(String token) throws HttpClientErrorException {
        return send("/users", token, HttpMethod.GET, null);
    }

    public String sendVerificationEmail(String token) throws HttpClientErrorException {
        return send("/users/email", token, HttpMethod.POST, null);
    }

    public String verifyEmail(String token) throws JSONException, HttpClientErrorException {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("token", token);
    ...
    public String sendResetPasswordEmail(String token)
        throws JSONException, HttpClientErrorException {
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("token", token);
